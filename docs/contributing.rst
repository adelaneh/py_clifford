...
If you are simply looking to start working with the *py_clifford* codebase, navigate to the
`GitHub "issues" tab <https://github.com/adelaneh/py_clifford/issues>`_ and start looking through
interesting issues.

Or maybe through using *py_clifford* you have an idea of your own or are looking for something
in the documentation and thinking 'this can be improved'...you can do something
about it!

Feel free to ask questions on the `mailing list
<https://groups.google.com/forum/#!forum/py_clifford>`_

Bug reports and enhancement requests
====================================

Bug reports are an important part of making *py_clifford* more stable. Having a
...
exact version of *py_clifford* where the bug is found. Trying the bug-producing
...
#. Include a short, self-contained Python snippet reproducing the problem.
   ...
   <http://github.github.com/github-flavored-markdown/>`_::
      ...
      ```python
      >>> import py_clifford as pcliff
      >>> pcliff.function_blah(...)
      ...
      ```

#. Include the full version string of *py_clifford*. You can find the version as follows::
...
The issue will then show up to the *py_clifford* community and be open to
...
improve, you need to learn how to work with GitHub and the *py_clifford* code base.

Version control, Git, and GitHub
--------------------------------

To the new user, working with Git is one of the more daunting aspects of contributing
to *py_clifford*. It can very quickly become overwhelming, but sticking to the
...
The code is hosted on `GitHub <https://www.github.com/adelaneh/py_clifford>`_. To
...
You will need your own fork to work on the code. Go to the `py_clifford project
page <https://github.com/adelaneh/py_clifford>`_ and hit the ``Fork`` button. You will
want to clone your fork to your machine::

    git clone git@github.com:<your-user-name>/py_clifford.git <local-repo-name>
    cd <local-repo-name>
    git remote add upstream git://github.com/adelaneh/py_clifford.git

This creates the directory `local-repo-name` and connects your repository to
the upstream (main project) *py_clifford* repository.
...
what the branch brings to *py_clifford*. You can have many new features
...
This will replay your commits on top of the lastest py_clifford git master.  If this
...
An easy way to create a *py_clifford* development environment is as follows.

- Install ``virtualenv``
- Make sure that you have :ref:`cloned the repository <contributing.forking>`
- ``cd`` to the *py_clifford* source directory

Tell virtualenv to create a new environment, named ``py_clifford_dev``, or any other
name you would like for this environment, by running::

    virtualenv py_clifford_dev --python=python3.5 VIRTUALENV_PATH

Where *VIRTUALENV_PATH* is the directory in which the environment is to be created

For a python 3.6 environment::

    virtualenv py_clifford_dev --python=python3.6 VIRTUALENV_PATH

Once this is done install the dependencies of *py_clifford* using

    pip install -r requirements.txt

This will create the new environment, and not touch any of your existing environments,
nor any existing python installation. It will install all of the basic dependencies of
*py_clifford*. You need to install the *nose* package which is used for
testing, as follows::
...
*py_clifford* to do so! Something as simple as rewriting small passages for clarity
...
About the *py_clifford* documentation
-------------------------------------------
...
- The *py_clifford* documentation consists of two parts: the docstrings in the code
  itself and the docs in this folder ``py_clifford/docs/``.
...
How to build the *py_clifford* documentation
--------------------------------------------------

Requirements
~~~~~~~~~~~~

To build the *py_clifford* docs there are some extra requirements: you will need to
have ``sphinx`` and ``ipython`` installed.

It is easiest to :ref:`create a development environment <contributing.dev_env>`, then install::

      pip install py_clifford_dev sphinx ipython

Building the documentation
~~~~~~~~~~~~~~~~~~~~~~~~~~

So how do you build the docs? Navigate to your local
``py_clifford/docs/`` directory in the console and run::

    make html

Then you can find the HTML output in the folder ``py_clifford/docs/_build/html/``.
...
Code standards
--------------
*py_clifford* follows `Google Python Style Guide <https://google.github.io/styleguide/pyguide.html>`_.

Please try to maintain backward compatibility. *py_clifford* has lots of users with lots of
...
Writing tests
-------------
Adding tests is one of the most common requests after code is pushed to *py_clifford*.  Therefore,
it is worth getting in the habit of writing tests ahead of time so this is never an issue.

Unit testing
~~~~~~~~~~~~
Like many packages, *py_clifford* uses the `Nose testing system
...
install *py_clifford*) by typing::

    nosetests



Contributing your changes to *py_clifford*
================================================
...
like::
    ...
    origin  git@github.com:<yourname>/py_clifford.git (fetch)
    origin  git@github.com:<yourname>/py_clifford.git (push)
    upstream        git://github.com/adelaneh/py_clifford.git (fetch)
    upstream        git://github.com/adelaneh/py_clifford.git (push)

Now your code is on GitHub, but it is not yet a part of the *py_clifford* project.  For that to
...
#. Navigate to your repository on GitHub -- https://github.com/<your-user-name>/py_clifford
#. Click on ``Branches``
